...
class FortniteViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        refreshControl.addTarget(self, action: #selector(FortniteViewController.refresh(sender:)), for: .valueChanged)
...
extension FortniteViewController: UITableViewDelegate, UITableViewDataSource {
